...
export const Route = createFileRoute("/1xbet")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Step-by-step guide to registering a 1xBet account and finding your Player ID for deposits and withdrawals." },
      { property: "og:title", content: "1xBet Registration Guide — Fast Cash" },
      { property: "og:description", content: "Step-by-step guide to registering a 1xBet account and finding your Player ID for deposits and withdrawals." },
    ],
  }),
  component: Page,
});
