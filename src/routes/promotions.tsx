...
export const Route = createFileRoute("/promotions")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Current 1xBet promo code and bonus information for players registering through Fast Cash." },
      { property: "og:title", content: "Promotions & Bonus Code — Fast Cash" },
      { property: "og:description", content: "Current 1xBet promo code and bonus information for players registering through Fast Cash." },
    ],
  }),
  component: Page,
});
