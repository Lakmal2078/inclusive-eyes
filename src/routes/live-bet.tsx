...
export const Route = createFileRoute("/live-bet")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "How live in-play betting works on 1xBet, and how to top up your balance quickly with Fast Cash." },
      { property: "og:title", content: "Live Betting Guide — Fast Cash" },
      { property: "og:description", content: "How live in-play betting works on 1xBet, and how to top up your balance quickly with Fast Cash." },
    ],
  }),
  component: Page,
});
