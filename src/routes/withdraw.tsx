...
export const Route = createFileRoute("/withdraw")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Submit your 1xBet withdrawal security code with your bank details and an agent will process the payout after review." },
      { property: "og:title", content: "Withdrawal Request — Fast Cash" },
      { property: "og:description", content: "Submit your 1xBet withdrawal security code with your bank details and an agent will process the payout after review." },
    ],
  }),
  component: Page,
});
