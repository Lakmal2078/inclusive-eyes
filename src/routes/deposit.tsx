...
export const Route = createFileRoute("/deposit")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Send your deposit to an agent bank or iPay account, then submit your Player ID, amount and receipt for review." },
      { property: "og:title", content: "Deposit Request — Fast Cash" },
      { property: "og:description", content: "Send your deposit to an agent bank or iPay account, then submit your Player ID, amount and receipt for review." },
    ],
  }),
  component: Page,
});
