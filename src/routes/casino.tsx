...
export const Route = createFileRoute("/casino")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "How to play 1xBet casino games and fund your account through Fast Cash agents." },
      { property: "og:title", content: "Casino Guide — Fast Cash" },
      { property: "og:description", content: "How to play 1xBet casino games and fund your account through Fast Cash agents." },
    ],
  }),
  component: Page,
});
