...
export const Route = createFileRoute("/transactions")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Track the status of every deposit and withdrawal request you have submitted to Fast Cash." },
      { property: "og:title", content: "My Requests — Fast Cash" },
      { property: "og:description", content: "Track the status of every deposit and withdrawal request you have submitted to Fast Cash." },
    ],
  }),
  component: Page,
});
