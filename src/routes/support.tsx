...
export const Route = createFileRoute("/support")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Get answers about deposits, withdrawals, Player IDs and responsible gambling, or reach an agent on WhatsApp." },
      { property: "og:title", content: "Support & FAQ — Fast Cash" },
      { property: "og:description", content: "Get answers about deposits, withdrawals, Player IDs and responsible gambling, or reach an agent on WhatsApp." },
    ],
  }),
  component: Page,
});
