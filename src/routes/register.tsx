...
export const Route = createFileRoute("/register")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Create a Fast Cash account to save your Player ID and follow every request you submit." },
      { property: "og:title", content: "Create Account — Fast Cash" },
      { property: "og:description", content: "Create a Fast Cash account to save your Player ID and follow every request you submit." },
    ],
  }),
  component: Page,
});
