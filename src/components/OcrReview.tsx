    ...
    <div className="mx-auto w-full max-w-2xl px-4 py-10">
      <header className="mb-8">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Scan a deposit slip, check each field's confidence score, correct anything that looks wrong,
          then save.
        </p>
      </header>
      ...
      {stage === "idle" && (
        <Card className="border-dashed p-8 text-center">
          ...
          <p className="mt-1 text-xs text-muted-foreground">JPG or PNG · processed on your device</p>
